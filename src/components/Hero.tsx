...
const processCards = [
  [
    "SEO Audit",
    "Technical issue, page structure, and priority mapped"
  ],
  [
    "Keyword Mapping",
    "Keyword, search intent, and target page aligned"
  ],
  [
    "GSC Report",
    "Clicks, impressions, CTR, and queries reviewed"
  ],
  [
    "Optimization",
    "Recommendation summarized into next SEO action"
  ]
];
const heroStats = [
  [
