      ...
      <div className="site-container">
        <Reveal>
          <SectionTitle
            ...
            title="Why Hire Me?"
            description="Alasan mengapa saya siap dipertimbangkan untuk posisi Junior SEO Specialist, SEO Content Specialist, SEO Analyst Assistant, atau Digital Marketing SEO Assistant."
          />
        </Reveal>
